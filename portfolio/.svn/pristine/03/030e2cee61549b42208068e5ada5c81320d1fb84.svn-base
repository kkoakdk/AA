						...
						<fieldset>
							...
							<table summary="표 내용은 Ses & Food 글쓰기 박스입니다."
								...
								<td class="tleft">
										...
										<input type="text" id="memberId" name="memberId" class="input_100" readonly="readonly" value="${sessionScope.memberId}" /></td>
							...
							<div class="btn_bottom">
								<div class="btn_bottom_right">
									...
									<input type="button" value="작성취소" title="작성취소" onclick="javascript:window.history.back();" /> 
										...
										<input type="button" value="완료" title="완료" id ="write" />
